    ...
    <div className="events-slider swiper" data-aos="fade-up" data-aos-delay={100}>
      <div className="swiper-wrapper">
        <div className="swiper-slide">
          <div className="row event-item">
            <div className="col-lg-6">
              <img src="src/assets/img/event-birthday.jpg" className="img-fluid"  />
            </div>
        ...
        <div className="swiper-slide">
          <div className="row event-item">
            <div className="col-lg-6">
              <img src="assets/img/event-private.jpg" className="img-fluid"  />
            </div>
            <div className="col-lg-6 pt-4 pt-lg-0 content">
        ...
        <div className="swiper-slide">
          <div className="row event-item">
            <div className="col-lg-6">
              <img src="src/assets/img/event-custom.jpg" className="img-fluid"  />
            </div>
            <div className="col-lg-6 pt-4 pt-lg-0 content">
